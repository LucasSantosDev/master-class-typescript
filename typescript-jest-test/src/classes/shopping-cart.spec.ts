...
const createSutWithProducts = () => {
  ...
  const cartItem2 = createCartItem('Shorts', 30.99);
  sut.addItem(cartItem1, cartItem2);
...
describe('ShoppingCart', () => {
  ...
  it('should test total and totalWithDiscount', () => {
    ...
    expect(sut.total()).toBe(70.99);
    expect(sut.totalWithDiscount()).toBe(70.99);
  });
